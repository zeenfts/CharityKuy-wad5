...
<nav class="navbar navbar-expand-md navbar-light shadow-sm sticky-top"
    ...
    <div class="container">
        <a class="navbar-brand"
            href={{ ((auth()->user()) and (auth()->user()->roles == 'admin_role')) ? route('dashboard.main') : route('menus.index') }}><img
                src="{{ asset('/img_static/logoCharity.png') }}" width="150"></a>
            ...
            <ul class="navbar-nav font-weight-bold ml-auto">
                ...
                <li class="nav-item dropdown justify-content-end">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                        ...
                        <img src="{{ $img_link[ord(strtoupper(auth()->user()->name[0])) - ord('A')] }}"
                            class="rounded-circle" style="width: 2.5em; height: 2.5em" alt="">
                    </a>
